...
{ 
        ...
        if(category=="Normal")
	{
        ...
        finalCost = (budget - ticketCost) + 0.000005;
        
        if (finalCost > 0.0)
        {
            res= "Yes! You have " + to_string(finalCost) + " leva left.";
            return res;
        }
        
        else
        {
            res="Not enough money! You need " + to_string(-finalCost) + " leva.";
            return res;
        }
